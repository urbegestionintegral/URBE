            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">Formulario de Comentarios</h5>
						<?php echo $msg; ?><?php echo $error; ?>
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="user-id">Nombres</label>
                                    <input type="text" name="name" class="form-control" placeholder="Ingresar Nombre">
                                </div>                
                                
                                <div class="form-group">
                                    <label for="phone">Teléfono o Celular</label>
                                    <input type="text" name="phone"  class="form-control" placeholder="Ingresar Teléfono o Celular" maxlength="10">
                                </div>

                                <div class="form-group">
                                    <label for="about-me">Descripción</label>
                                    <textarea class="form-control" name="content" rows="7" placeholder="Ingresar Descripción"></textarea>
                                </div>
                                <input type="submit" class="btn btn-secondary mb-4" name="insert" value="Enviar">
                            </div>
							</form>
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <div class="user-info mt-md-50"> <img src="admin/user/<?php echo $row['6'];?>" alt="userimage">
                                    ...
                                    <div class="font-18">
                                        <div class="mb-1 text-capitalize"><b>Nombre:</b> <?php echo $row['1'];?></div>
                                        <div class="mb-1 text-capitalize"><b>Correo:</b> <?php echo $row['2'];?></div>
                                        <div class="mb-1 text-capitalize"><b>Teléfono o Celular:</b> <?php echo $row['3'];?></div>
										<div class="mb-1 text-capitalize"><b>Rol:</b> <?php echo $row['5'];?></div>
                                    </div>
									<?php } ?>
                                </div>
                            </div>
