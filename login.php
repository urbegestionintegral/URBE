    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Ingresar</b></h2>
                    </div>
                    <div class="col-md-6">
							...
							<div class="login-right-wrap">
								...
								<form method="post">
									...
									<div class="form-group">
										...
										<button class="btn btn-secondary" name="login" value="Login" type="submit">Ingresar</button>
								...
								<div class="text-center dont-have">No tienes cuenta? <a href="register.php">Registrate</a></div>
