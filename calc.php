    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Propiedades de los Usuarios</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="index.php">URBE</a></li>
                                <li class="breadcrumb-item active">Propiedades de los Usuarios</li>
                            </ol>
                        </nav>
                    </div>
                </div>
					...
					<table class="items-list col-lg-6" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-secondary">
                                <th class="text-white font-weight-bolder">Precio</th>
                                <th class="text-white font-weight-bolder">Cantidad</th>
                             </tr>
                        </thead>
                        <tbody>
